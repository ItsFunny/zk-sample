module github.com/okx/zk-demo

go 1.19

require (
	github.com/0xPolygonHermez/zkevm-node v0.0.1-RC5
...
require (
	...
	github.com/iden3/go-iden3-crypto v0.0.14-0.20220413123345-edc36bfa5247 // indirect
